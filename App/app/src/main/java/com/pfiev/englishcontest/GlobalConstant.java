...
public class GlobalConstant {
    public static int GOOGLE_ACCOUNT_TYPE = 0;
    public static int FACEBOOK_ACCOUNT_TYPE = 1;
    public static int TWITTER_ACCOUNT_TYPE = 2;
    ...
    public static String MATCH_HISTORY = "match_history";
