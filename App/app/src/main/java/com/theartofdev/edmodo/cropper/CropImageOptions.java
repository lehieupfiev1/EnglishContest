...
public class CropImageOptions implements Parcelable {
  ...
  /** The type of cropping screen. */
  public CropImageView.CropScreenType cropScreenType;
  ...
  /** the optional color of the border lines */
  public int optBorderLineColor;
  ...
  /** the option thickness of borderline for photo drawing crop screen. (in pixels) */
  public float optBorderLineThickness;

  /**
   * the option length of the corner line away from the corner for photo drawing crop screen.
   * (in pixels)
   */
  public float optBorderCornerLength;
  ...
  public CropImageOptions() {
    ...
    cropScreenType = CropImageView.CropScreenType.COMMON;
    ...
    borderLineThickness = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, dm);
    borderLineColor = Color.argb(127, 250, 250, 250);
    ...
    borderCornerLength = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 26, dm);
    borderCornerColor = Color.WHITE;

    optBorderLineThickness = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3, dm);
    optBorderLineColor = Color.argb(170, 255, 255, 255);
    optBorderCornerLength = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 14, dm);

    guidelinesThickness = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, dm);
    guidelinesColor = Color.argb(170, 255, 255, 255);
    backgroundColor = Color.argb(127, 0, 0, 0);
  ...
  protected CropImageOptions(Parcel in) {
    cropScreenType = CropImageView.CropScreenType.values()[in.readInt()];
  ...
  public void writeToParcel(Parcel dest, int flags) {
    dest.writeInt(cropScreenType.ordinal());
