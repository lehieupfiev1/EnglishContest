...
public class CropImageView extends FrameLayout {
  ...
  public CropImageView(Context context, AttributeSet attrs) {
    ...
    if (attrs != null) {
      ...
      try {
        ...
        options.scaleType =
                ScaleType.values()[ta.getInt(R.styleable.CropImageView_cropScaleType, options.scaleType.ordinal())];
        ...
        options.cropScreenType =
                CropScreenType.values()[ta.getInt(R.styleable.CropImageView_cropScreenType, options.cropScreenType.ordinal())];
        options.cropShape =
                CropShape.values()[ta.getInt(R.styleable.CropImageView_cropShape, options.cropShape.ordinal())];
        options.guidelines =
                Guidelines.values()[
                        ta.getInt(R.styleable.CropImageView_cropGuidelines, options.guidelines.ordinal())];
        options.snapRadius =
        ...
        options.borderLineThickness =
                ta.getDimension(R.styleable.CropImageView_cropBorderLineThickness, options.borderLineThickness);
        options.optBorderLineThickness =
                ta.getDimension(R.styleable.CropImageView_cropOptBorderLineThickness, options.optBorderLineThickness);
        options.borderLineColor =
                ta.getInteger(R.styleable.CropImageView_cropBorderLineColor, options.borderLineColor);
        options.optBorderLineColor =
                ta.getInteger(R.styleable.CropImageView_cropOptBorderLineColor, options.optBorderLineColor);
        options.borderCornerThickness =
                ta.getDimension(R.styleable.CropImageView_cropBorderCornerThickness, options.borderCornerThickness);
        options.borderCornerOffset =
                ta.getDimension(R.styleable.CropImageView_cropBorderCornerOffset, options.borderCornerOffset);
        options.borderCornerLength =
                ta.getDimension(R.styleable.CropImageView_cropBorderCornerLength, options.borderCornerLength);
        options.optBorderCornerLength =
                ta.getDimension(R.styleable.CropImageView_cropOptBorderCornerLength, options.optBorderCornerLength);
        options.borderCornerColor =
                ta.getInteger(R.styleable.CropImageView_cropBorderCornerColor, options.borderCornerColor);
        options.guidelinesThickness =
                ta.getDimension(R.styleable.CropImageView_cropGuidelinesThickness, options.guidelinesThickness);
        ...
        options.minCropWindowWidth =
                (int) ta.getDimension(R.styleable.CropImageView_cropMinCropWindowWidth, options.minCropWindowWidth);
        options.minCropWindowHeight =
                (int) ta.getDimension(R.styleable.CropImageView_cropMinCropWindowHeight, options.minCropWindowHeight);
        options.minCropResultWidth =
                (int) ta.getFloat(R.styleable.CropImageView_cropMinCropResultWidthPX, options.minCropResultWidth);
        options.minCropResultHeight =
                (int) ta.getFloat(R.styleable.CropImageView_cropMinCropResultHeightPX, options.minCropResultHeight);
        ...
        options.maxCropResultHeight =
                (int) ta.getFloat(R.styleable.CropImageView_cropMaxCropResultHeightPX, options.maxCropResultHeight);
        options.flipHorizontally =
                ta.getBoolean(R.styleable.CropImageView_cropFlipHorizontally, options.flipHorizontally);
  ...
  /**
   * The type of cropping screen - common/optional.<br>
   */
  public void setCropScreenType(CropScreenType cropScreenType){
    mCropOverlayView.setCropScreenType(cropScreenType);
  }
  ...
  public void setConners(Conners conners) {
    mCropOverlayView.setConners(conners);
  }
  ...
  /**
   * Gets the uncropped image based on the current ImageView.
   *
   * @return a new Bitmap representing the uncropped image
   */
  public Bitmap getUnCroppedBitmap() {
    ...
    return Bitmap.createBitmap(mBitmap, 0, 0, width, height, mImageMatrix, true);
  }
  ...
  public Bitmap getCroppedImage(int reqWidth, int reqHeight, RequestSizeOptions options) {
    ...
    if (mBitmap != null) {
      if (getContext() instanceof Activity) {
        ((Activity) getContext()).runOnUiThread(mImageView::clearAnimation);
      }
  ...
  public Parcelable onSaveInstanceState() {
    ...
    if (imageUri != null && mBitmap != null) {
      ...
      BitmapUtils.setStateBitmap(new Pair<>(key, new WeakReference<>(mBitmap)));
    ...
    bundle.putString("CROP_SCREEN_TYPE", mCropOverlayView.getCropScreenType().name());
  ...
  public void onRestoreInstanceState(Parcelable state) {
    ...
    if (state instanceof Bundle) {
      ...
      if (mBitmapLoadingWorkerTask == null
          ...
          if (key != null) {
            Bitmap stateBitmap =
                BitmapUtils.mStateBitmap != null && BitmapUtils.mStateBitmap.first.equals(key)
                    ...
                    : null;
            BitmapUtils.setStateBitmap(null);
        ...
        mCropOverlayView.setCropScreenType(CropScreenType.valueOf(bundle.getString("CROP_SCREEN_TYPE")));
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (mBitmap != null) {
      ...
      if (Double.compare(viewToBitmapWidthRatio, Double.POSITIVE_INFINITY) != 0
              || Double.compare(viewToBitmapHeightRatio, Double.POSITIVE_INFINITY) != 0) {
  ...
  private void setProgressBarVisibility() {
    boolean visible = mShowProgressBar && (mBitmap == null && mBitmapLoadingWorkerTask != null);
  ...
  // region: Inner class: CropScreenType

  /**
   * The possible cropping screen view type.<br>
   */
  public enum CropScreenType{

    /**
     * Common OneUI cropping screen
     */
    COMMON,

    /**
     * Pen Up cropping screen
     */
    OPTIONAL
  }
  // endregion
